...
const CreateAuction = () => {
  ...
  return (
    <article className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col ">
      ...
      <div className="bg-gradient-to-br from-[#fff3fd] via-[#fde4cf] to-[#f8fafc] mx-auto w-full h-auto px-2 flex flex-col gap-4 items-center py-4 justify-center rounded-md">
        <form
